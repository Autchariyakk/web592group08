...
<html lang="en">
  <head>
    ...
    <title>MOOPA BIPOLAR GIRL... SHOP</title>
...
$(document).ready(function () {
 ...
 $(window).load(function(){
  ...
  <body>
<BODY background="page-bg-1.jpg"></BODY>
    <!-- Fixed navbar -->
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php"><img src="img/pp.png" width="150" height="100"alt="" /></a>
